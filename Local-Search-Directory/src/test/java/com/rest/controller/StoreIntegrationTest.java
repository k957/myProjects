...
public class StoreIntegrationTest {
	...
	public void testViewAll() {
		String url = "http://localhost:" + port + "/v1/store";
	...
	public void testViewOne() {
		String url = "http://localhost:" + port + "/v1/store/4";
		MerchantDto merchantDto=createMerchantfunc();
		String password=merchantService.create(merchantDto);
		User user = new User();
		user=userService.loginUser("kkk@gmail.com", password);
...
//detach
	...
	public void testCreate() {
		...
		ResponseEntity<StoreDto> response = testRestTemplate.exchange(url, HttpMethod.POST,entity,StoreDto.class);
	...
	public void testUpdate() {
		...
		HttpEntity<StoreDto> entity = new HttpEntity<>(storeDto, headers);
		ResponseEntity<StoreDto> response = testRestTemplate.exchange(url, HttpMethod.PUT,entity,StoreDto.class);
	...
	public void testDelete() {
		...
		HttpEntity<StoreDto> entity = new HttpEntity<>(storeDto, headers);
		ResponseEntity<StoreDto> response = testRestTemplate.exchange(url, HttpMethod.DELETE,entity,StoreDto.class);
