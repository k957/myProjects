...
import com.example.service.PaymentMethodServiceImpl;
...
public class PaymentMethodUnitTest {
	...
	public void testViewAll() {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/v1/PaymentMethod").headers(headers)
	...
	public void testViewOne() {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/v1/PaymentMethod/48").headers(headers)
				.contentType(MediaType.APPLICATION_JSON);
	...
	public void testCreate() {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.post("/v1/PaymentMethod").headers(headers).accept(MediaType.APPLICATION_JSON)
				.content(paymentMethodJson).contentType(MediaType.APPLICATION_JSON);
	...
	public void testUpdate() {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/v1/PaymentMethod/48").headers(headers).accept(MediaType.APPLICATION_JSON)
				.content(paymentMethodJson).contentType(MediaType.APPLICATION_JSON);
	...
	public void testUpdateWhenNoIdInUrl() {
		...
		String paymentMethodJson = "{\n" + 
				...
				"}";
		;
		RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/v1/PaymentMethod/").accept(MediaType.APPLICATION_JSON)
				.content(paymentMethodJson).contentType(MediaType.APPLICATION_JSON).headers(headers);
	...
	public void testDelete() {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/v1/PaymentMethod/48").headers(headers);
